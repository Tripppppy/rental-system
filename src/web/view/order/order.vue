...
<template>
  <div class="smart-crud-container">
    ...
    <Modal
      ...
      cancel-text="取消"
      title="编辑order">
      <Form ref='orderForm' :model='orderForm' :rules='orderFormRule' :label-width='80'><FormItem label='球类' prop='ball_id' ><Input v-model='orderForm.ball_id' :maxlength=-1 placeholder='请输入ball_id' /></FormItem><FormItem label='租球人' prop='user_id' ><Input v-model='orderForm.user_id' :maxlength=-1 placeholder='请输入user_id' /></FormItem><FormItem label='租球日期' prop='order_rent_date' ><Input v-model='orderForm.order_rent_date' :maxlength=-1 placeholder='请输入order_rent_date' /></FormItem><FormItem label='还球日期' prop='order_return_date' ><Input v-model='orderForm.order_return_date' :maxlength=-1 placeholder='请输入order_return_date' /></FormItem><FormItem label='实际花费' prop='cost' ><Input v-model='orderForm.cost' :maxlength=-1 placeholder='请输入cost' /></FormItem><FormItem label='订单状态' prop='status' ><Input v-model='orderForm.status' :maxlength=-1 placeholder='请输入status' /></FormItem></Form><div slot="footer">
...
export default {
  ...
  methods: {
    ...
    add() {
      this.isSaving = false;
      this.orderForm = {ball_id: undefined, user_id: undefined, order_rent_date: undefined, order_return_date: undefined, cost: undefined, status: undefined, };
      this.editModal = true;
    },
